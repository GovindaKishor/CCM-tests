//To explore and validate Admin section in workbench(for ccm 6.0.0-SNAPSHOT Tue Jan 24 09:28:15 CET 2023)
...
test('test', async ({ page }) => {
  ...
  await page.getByRole('treeitem', { name: 'i18n columns icos search-masks' }).getByRole('treeitem', { name: 'columns' }).locator('svg').click();
  await page.getByText('resources_en.properties').click();
  await page.getByText('bpm-catalogbpmnPTMCorporate.bpmnPTMCorporateMT.bpmnPTMFICDD.bpmnPTMRetailDE.bpmn').click();
