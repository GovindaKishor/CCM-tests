...
test('test', async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'Reset filter' }).click();
  await page.getByText('Active 17').click();
  await page.getByRole('button', { name: 'Reset filter' }).click();
  await page.getByText('Individual 12').click();
  await page.getByRole('button', { name: 'Reset filter' }).click();
  await page.getByText('CORP 2').click();
  await page.getByRole('button', { name: 'Reset filter' }).click();
  await page.getByText('SironAML 17').click();
  await page.getByRole('button', { name: 'Reset filter' }).click();
  await page.getByText('Default Siron Case 17').click();
  await page.getByRole('button', { name: 'Reset filter' }).click();
  await page.getByText('Last week 17').click();
  await page.getByRole('button', { name: 'Reset filter' }).click();
