//Case status must be translated when I change user language.
...
test('test', async ({ page }) => {
  ...
  await page.locator('div:nth-child(2) > .css-1ssirbu > .css-mslw24 > .MuiButtonBase-root > .PrivateSwitchBase-input').click();
